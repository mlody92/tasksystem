...
namespace TaskSystem.Issues
{
    public partial class View : System.Web.UI.Page
    {
        ...
        private void dataProject()
        {
            ...
            DataTable dt5 = TaskSystem.tools.GetData("SELECT distinct(sprint.id), sprint.name FROM [sprint] JOIN issue on issue.sprint_id=sprint.id WHERE sprint.status='open' OR issue.id='" + Label2.Text + "' ORDER BY sprint.id");
