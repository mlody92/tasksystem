<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Priority.aspx.cs" Inherits="TaskSystem.Issues.Priority" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

     <h3 class="blank1">Issues priority</h3>
                ...
                <div class="modal-body">
                    <div class="form-horizontal">
                        <div class="form-group mb-n">
                            <label class="col-md-2 control-label">Priority name</label>
                            <div class="col-md-8">
                                <input id="Text1" runat="server" type="text" class="form-control1" placeholder="Priority name" />
                            </div>
                        </div>
                    </div>
                </div>
